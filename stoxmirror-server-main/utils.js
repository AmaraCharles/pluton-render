...
//     to: "support@proultimatewealth.com ", // list of receivers
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    from: `"proultimatewealth Team" <${process.env.EMAIL_USER}>`, // sender address
    to: to, // recipient address
    subject: "Welcome to proultimatewealth!", // subject line
    html: `
      <html>
      <head>
        <style>
      ...
      <body>
        <div class="email-container">
          <div class="header">
            <img src="cid:logo" alt="proultimatewealth Logo">
            
          </div>
          <div class="content">
            <h2>Welcome to proultimatewealth!</h2>
            <p>
              Thank you for joining proultimatewealth! We're excited to have you on board.
            ...
            <p>Best regards,</p>
            <p>The proultimatewealth Team</p>
          </div>
          <div class="footer">
            <p>
              If you did not sign up for proultimatewealth, please ignore this email or
